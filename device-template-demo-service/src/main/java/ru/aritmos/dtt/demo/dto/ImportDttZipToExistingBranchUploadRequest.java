...
/**
 * JSON-метаданные для multipart upload merge-импорта zip-архива с .dtt файлами в существующий DeviceManager.json.
 *
 * @param existingBranchJson исходный branch JSON
 ...
 */
@Schema(description = "JSON-метаданные для multipart upload merge-импорта zip-архива в существующий branch equipment JSON")
public record ImportDttZipToExistingBranchUploadRequest(
