 ...
 * @param branchJson branch equipment JSON как объект (альтернатива branchEquipment)
...
public record ExportSingleDttFromBranchRequest(
        ...
        @Schema(description = "Branch equipment JSON как объект (альтернатива branchEquipment)", type = "object")
        JsonNode branchJson,
